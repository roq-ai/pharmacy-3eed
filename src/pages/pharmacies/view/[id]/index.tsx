            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('pharmacy', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/pharmacies/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="pharmacy" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
