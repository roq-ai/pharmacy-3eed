...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order #123 has been placed by Customer X.create': {
    roles: ['owner', 'pharmacy-manager'],
    key: 'order_create',
    tenantPath: [],
    userPath: [],
  },
  'Pharmacy Manager Y has updated the inventory.update': {
    roles: ['owner', 'pharmacy-manager'],
    key: 'inventory_update',
    tenantPath: [],
    userPath: [],
  },
  'Prescription #456 has been received from Customer Z.create': {
    roles: ['owner', 'pharmacy-manager'],
    key: 'prescription_create',
    tenantPath: [],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['owner', 'pharmacy-manager'];
