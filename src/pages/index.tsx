  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Pharmacy: Streamlining operations, planning, and procurement of medicines, empowering you to focus on serving your retail customers efficiently."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1585435557343-3b092031a831?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxwaGFybWFjeXxlbnwwfHx8fDE2OTU2MTQ1NzN8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Pharmacy: Streamlining operations, planning, and procurement of medicines, empowering you to focus on serving your retail customers efficiently.`}
            </Text>
            <Box
